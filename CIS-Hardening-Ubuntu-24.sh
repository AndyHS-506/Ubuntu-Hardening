...
run_command 'chmod 600 /etc/passwd-' "7.1.2 Secure /etc/passwd- backup (600)"
...
run_command 'chmod 600 /etc/group-' "7.1.4 Secure /etc/group- backup (600)"
run_command 'chown root:root /etc/group-' "7.1.4 Verify /etc/group- ownership"
run_command 'chmod 000 /etc/shadow' "7.1.5 Lock /etc/shadow permissions (000)"
run_command 'chown root:shadow /etc/shadow' "7.1.5 Set /etc/shadow ownership"
...
run_command 'chown root:shadow /etc/gshadow' "7.1.7 Set /etc/gshadow ownership"
